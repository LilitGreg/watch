 ...
 * Plugin URI: http://www.themelocation.com/woocommerce/
...
if (!class_exists('DealOfDay')):
	...
	final class DealOfDay {
		...
		/**
		 * function to get the only instance of class, singleton
		 *
		 * @return object
		 */
...
/**
	 ...
	 * @return string
	 */
function dod_custom_add_to_cart_redirect() {
	$cart_page_url = get_permalink( wc_get_page_id( 'cart' ) ); 
		    return $cart_page_url; 
	}
		
add_filter( 'woocommerce_add_to_cart_redirect', 'dod_custom_add_to_cart_redirect' );
